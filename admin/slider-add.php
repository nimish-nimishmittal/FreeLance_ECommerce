...
if(isset($_POST['form1'])) {
    ...
    if($path!='') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' && $ext!='mp4' ) {
            $valid = 0;
            $error_message .= 'You must have to upload jpg, jpeg, gif, png or mp4 file<br>';
        }
    } else {
        $valid = 0;
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="padding-top:5px">
                                <input type="file" name="photo" accept="image/jpeg, image/png, image/gif, video/mp4">(Only jpg, jpeg, gif, png and mp4 are allowed)
                            </div>
                        </div>
                        <div class="form-group">
