...
<head>
	...
	<title>Ami Jivdaya Admin Panel</title>
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">Ami Jivdaya</span>
			</a>
			...
			<nav class="navbar navbar-static-top">
				...
				<span style="float:left;line-height:50px;color:#fff;padding-left:15px;font-size:18px;">Ami Jivdaya</span>
