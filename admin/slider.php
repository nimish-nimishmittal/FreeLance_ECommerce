							...
							foreach ($result as $row) {
								...
								<tr>
									...
									<td style="width:150px;">
										<?php
										// Assuming $row['type'] contains the file type (e.g., 'gif', 'mp4', etc.)
										$filePath = $row['photo'];

										// Check if the file path contains '.gif' or '.mp4' to determine the file type
										if (strpos($filePath, '.gif') !== false) {
											// Display the GIF using the <img> tag
											echo "<img src='../assets/uploads/$filePath' alt='{$row['heading']}' style='width:140px;'>";
										} elseif (strpos($filePath, '.mp4') !== false) {
											// Display the video using the <video> tag
											echo "<video controls style='width:140px;'>";
											echo "<source src='../assets/uploads/$filePath' type='video/mp4'>";
